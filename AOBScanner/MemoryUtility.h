...
public:
    ...
    static long ReadVigorAttr();
    static long ReadMindAttr();
    static long ReadEnduranceAttr();
    static long ReadLocalPlayerHealth();
    static long ReadLocalPlayerMana();
    static long ReadLocalPlayerStamina();
